...
method = "UNSW_NB_15_train_BBA_Smote_ENN"
...
X_train, X_valid, y_train, y_valid = train_test_split(X_train, y_train, test_size=1/7, random_state=42)
print(X_valid.shape)
print(X_train.shape)
