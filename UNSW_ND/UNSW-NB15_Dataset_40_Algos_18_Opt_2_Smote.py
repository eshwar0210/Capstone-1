...
method = "UNSW_NB_15_train_BBA_No_Smote"

## **Importing Datasets**
# # 1.NO_Opt
# train_data = pd.read_csv('UNSW_NB_15_train_No_Opt_No_Smote.csv')
# train_data = pd.read_csv('UNSW_NB_15_train_No_Opt_ENN.csv')
# train_data = pd.read_csv('UNSW_NB_15_train_No_Opt_IPF.csv')

# test_data = pd.read_csv('UNSW_NB_15_test_No_Opt.csv')

# # 2.BBA
train_data = pd.read_csv('UNSW_NB_15_train_BBA_No_Smote.csv')
# train_data = pd.read_csv('UNSW_NB_15_train_BBA_ENN.csv')
# train_data = pd.read_csv('UNSW_NB_15_train_BBA_IPF.csv')

test_data = pd.read_csv('UNSW_NB_15_test_BBA.csv')

# # 3.CS
# train_data = pd.read_csv('UNSW_NB_15_train_CS_No_Smote.csv')
# train_data = pd.read_csv('UNSW_NB_15_train_CS_ENN.csv')
# train_data = pd.read_csv('UNSW_NB_15_train_CS_IPF.csv')

# test_data = pd.read_csv('UNSW_NB_15_test_CS.csv')

# # 4.NO_Opt
# train_data = pd.read_csv('UNSW_NB_15_train_DE_No_Smote.csv')
# train_data = pd.read_csv('UNSW_NB_15_train_DE_ENN.csv')
# train_data = pd.read_csv('UNSW_NB_15_train_DE_IPF.csv')

# test_data = pd.read_csv('UNSW_NB_15_test_DE.csv')

# # 5.EO
# train_data = pd.read_csv('UNSW_NB_15_train_EO_No_Smote.csv')
# train_data = pd.read_csv('UNSW_NB_15_train_EO_ENN.csv')
# train_data = pd.read_csv('UNSW_NB_15_train_EO_IPF.csv')

# test_data = pd.read_csv('UNSW_NB_15_test_EO.csv')

# # 6.FA
# train_data = pd.read_csv('UNSW_NB_15_train_FA_No_Smote.csv')
# train_data = pd.read_csv('UNSW_NB_15_train_FA_ENN.csv')
# train_data = pd.read_csv('UNSW_NB_15_train_FA_IPF.csv')

# test_data = pd.read_csv('UNSW_NB_15_test_FA.csv')

# # 7.FPA
# train_data = pd.read_csv('UNSW_NB_15_train_FPA_No_Smote.csv')
# train_data = pd.read_csv('UNSW_NB_15_train_FPA_ENN.csv')
# train_data = pd.read_csv('UNSW_NB_15_train_FPA_IPF.csv')

# test_data = pd.read_csv('UNSW_NB_15_test_FPA.csv')

# # 8.GA
# train_data = pd.read_csv('UNSW_NB_15_train_GA_No_Smote.csv')
# train_data = pd.read_csv('UNSW_NB_15_train_GA_ENN.csv')
# train_data = pd.read_csv('UNSW_NB_15_train_GA_IPF.csv')

# test_data = pd.read_csv('UNSW_NB_15_test_GA.csv')

# # 9.GSA
# train_data = pd.read_csv('UNSW_NB_15_train_GSA_No_Smote.csv')
# train_data = pd.read_csv('UNSW_NB_15_train_GSA_ENN.csv')
# train_data = pd.read_csv('UNSW_NB_15_train_GSA_IPF.csv')

# test_data = pd.read_csv('UNSW_NB_15_test_GSA.csv')

# # 10.GWO
# train_data = pd.read_csv('UNSW_NB_15_train_GWO_No_Smote.csv')
# train_data = pd.read_csv('UNSW_NB_15_train_GWO_ENN.csv')
# train_data = pd.read_csv('UNSW_NB_15_train_GWO_IPF.csv')

# test_data = pd.read_csv('UNSW_NB_15_test_GWO.csv')

# # 11.HHO
# train_data = pd.read_csv('UNSW_NB_15_train_HHO_No_Smote.csv')
# train_data = pd.read_csv('UNSW_NB_15_train_HHO_ENN.csv')
# train_data = pd.read_csv('UNSW_NB_15_train_HHO_IPF.csv')
...
# train_data = pd.read_csv('UNSW_NB_15_train_HS_ENN.csv')
# train_data = pd.read_csv('UNSW_NB_15_train_HS_IPF.csv')

# test_data = pd.read_csv('UNSW_NB_15_test_HS.csv')

# # 13.JA
# train_data = pd.read_csv('UNSW_NB_15_train_JA_No_Smote.csv')
# train_data = pd.read_csv('UNSW_NB_15_train_JA_ENN.csv')
# train_data = pd.read_csv('UNSW_NB_15_train_JA_IPF.csv')

# test_data = pd.read_csv('UNSW_NB_15_test_JA.csv')

# # 14.MA
# train_data = pd.read_csv('UNSW_NB_15_train_MA_No_Smote.csv')
# train_data = pd.read_csv('UNSW_NB_15_train_MA_ENN.csv')
# train_data = pd.read_csv('UNSW_NB_15_train_MA_IPF.csv')

# test_data = pd.read_csv('UNSW_NB_15_test_MA.csv')

# # 15.PSO
# train_data = pd.read_csv('UNSW_NB_15_train_PSO_No_Smote.csv')
# train_data = pd.read_csv('UNSW_NB_15_train_PSO_ENN.csv')
# train_data = pd.read_csv('UNSW_NB_15_train_PSO_IPF.csv')

# test_data = pd.read_csv('UNSW_NB_15_test_PSO.csv')

# # 16.RDA
# train_data = pd.read_csv('UNSW_NB_15_train_RDA_No_Smote.csv')
# train_data = pd.read_csv('UNSW_NB_15_train_RDA_ENN.csv')
# train_data = pd.read_csv('UNSW_NB_15_train_RDA_IPF.csv')

# test_data = pd.read_csv('UNSW_NB_15_test_RDA.csv')

# # 17.SCA
# train_data = pd.read_csv('UNSW_NB_15_train_SCA_No_Smote.csv')
# train_data = pd.read_csv('UNSW_NB_15_train_SCA_ENN.csv')
# train_data = pd.read_csv('UNSW_NB_15_train_SCA_IPF.csv')

# test_data = pd.read_csv('UNSW_NB_15_test_SCA.csv')

# # 18.SSA
# train_data = pd.read_csv('UNSW_NB_15_train_SSA_No_Smote.csv')
# train_data = pd.read_csv('UNSW_NB_15_train_SSA_ENN.csv')
# train_data = pd.read_csv('UNSW_NB_15_train_SSA_IPF.csv')

# test_data = pd.read_csv('UNSW_NB_15_test_SSA.csv')

# # 19.WOA
# train_data = pd.read_csv('UNSW_NB_15_train_WOA_No_Smote.csv')
# train_data = pd.read_csv('UNSW_NB_15_train_WOA_ENN.csv')
# train_data = pd.read_csv('UNSW_NB_15_train_WOA_IPF.csv')
...
def result(y_pred,y_test,algo,start,end_train,end_predict):
    ...
    file.write(str(format_decimal(metrics.explained_variance_score(y_test, y_pred)))+"\n")
...
result(y_pred,y_test,"SGD",start,end_train,end_predict)
